...
class tbl_Accountholders(models.Model):
    ...
    bankacnumber = models.CharField(null=True, max_length = 100)
...
# Admin User Tables
class tbl_Adminuser(models.Model):
    userimage = models.ImageField(blank=True, null=True)
    userimageurl = models.CharField(null=True,max_length = 100)
    ...
    username = models.CharField(max_length = 200)
    password = models.CharField(max_length = 200)
    userstatus = models.CharField(null=True, max_length = 100)
    createdate = models.DateTimeField(auto_now_add=True)
    role = models.CharField(null=True, max_length = 100)
    permission = models.CharField(null=True, max_length = 100)
    securitycode = models.CharField(null=True, max_length=100, blank=True, default=uuid.uuid4)
...
class tbl_PoetDetails(models.Model):
    ...
    conpetitionid = models.ForeignKey(tbl_CompetitionDetails, models.SET_NULL, null=True)
...
class tbl_PoetComments(models.Model):
    ...
    postid = models.ForeignKey(tbl_PoetDetails, on_delete=models.CASCADE)
    username = models.CharField(null=True, max_length = 100)
...
# Image Templates
class tbl_ImageTemplates(models.Model):
    templateimage = models.ImageField(blank=True, null=True)
    templateimageurl = models.CharField(null=True,max_length = 100)
    filename = models.CharField(null=True, max_length = 100)
    size = models.CharField(null=True, max_length = 200)
    createdate = models.CharField(null=True, max_length = 200)
    status = models.CharField(null=True, max_length = 100)
